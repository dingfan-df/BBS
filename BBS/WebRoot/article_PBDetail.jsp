...
<%
	...
	if (strId == null || strId.trim().equals("")) { //前后不能颠倒，因为若id为空时，id.trim()会报空指针异常
	...
	try {
		while (rs.next()) {
			...
			ar.setPid(rs.getInt("pid"));
			ar.setRootid(rs.getInt("rootid"));
			ar.setTitle(rs.getString("title"));
			ar.setCont(rs.getString("cont"));
			ar.setIsleaf(rs.getInt("isleaf") == 0 ? true : false);
			ar.setPdate(rs.getTimestamp("pdate"));
			articles.add(ar);
		}
	} catch (Exception e) {
																				...
																				<tbody>
																					<tr>
																						...
																						<td class="jive-icon-label"><a
																							href="reply1.jsp?id=<%=a.getId() %>&rootId=<%=a.getRootid() %>"
																							title="回复本主题">回复</a></td>
																					</tr>
																				</tbody>
																			</table>
																...
																<tr>
																	<td colspan="4"
																		...
																		·<a href="http://www.bjsxt.com"><font
																			color="#666666">http://www.bjsxt.com</font>
																	</a></td>
																</tr>
															</tbody>
														</table>
														...
														<tr>
															<td><a
																href="http://bbs.chinajavaworld.com/forum.jspa?forumID=20"><img
																	...
																	border="0" height="16" hspace="6" width="16">
															</a></td>
															<td><a
