...
<div id="jive-forumpage">
  ...
  <table border="0" cellpadding="3" cellspacing="0" width="100%">
    <tbody>
      <tr valign="top">
        <td style="width: 272px; "><span class="jive-paginator"> [ <a href="article_PB.jsp?pageNo=1 ">首页</a> | <a href="article_PB.jsp?pageNo=<%=pageNo-1>0?pageNo-1:1 %>">上一页</a>  | <a href="article_PB.jsp?pageNo=<%=pageNo+1>totalPages?totalPages:pageNo+1 %>">下一页</a>  | <a href="article_PB.jsp?pageNo=<%=totalPages %>">末页</a> </span>
        </td>
        </tr>
        <tr>
         <td> <form name="form1" action="article_PB.jsp">
          <select name="pageNo" onchange="document.form1.submit()">
             ...
             <td>
              <form name="form2" action="article_PB.jsp">
