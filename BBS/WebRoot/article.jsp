                ...
                <tbody>
                  ...
                  <tr class="jive-even">
                    ...
                    <td nowrap="nowrap" width="1%">
                    	<a href ="delete.jsp?id=<%=a.getId() %>&isLeaf=<%=a.getIsleaf()%>&pid=<%=a.getPid() %>">DEL
                    </td>
                    <td class="jive-thread-name" width="95%"><a id="jive-thread-1" href="articleDetail.jsp?id=<%=a.getId() %>"><%=aaa + a.getTitle()%></a></td>
